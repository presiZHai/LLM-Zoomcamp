...
* [Anthropic Claude](https://www.anthropic.com/api) (Get started testing Claude with US$5 in free credits)
* [Cohere AI](https://dashboard.cohere.com/api-keys) (Trial keys are free of charge)
